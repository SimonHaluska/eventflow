...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/haka.agency",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/haka.agency",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/haka-agency",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@haka.agency",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
    ...
    <footer className="bg-charcoal px-6 py-16 text-background">
      <div className="mx-auto max-w-5xl space-y-10">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-4">
          ...
          {/* Navigácia */}
          <div className="self-start sm:pt-[10px]">
          ...
          <div className="flex flex-col gap-4 self-start sm:pt-[10px]">
